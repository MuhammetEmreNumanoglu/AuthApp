...
export default function CoursesMasonryComponent({ coursesShows }) {
  const [courses] = useState(coursesShows);
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="mt-10">
        ...
        <button className="group mx-auto flex items-center gap-2 rounded-full border border-gray-200 bg-white px-7 py-3 text-sm font-semibold text-gray-700 shadow-sm transition-all duration-300 hover:border-gray-300 hover:bg-gray-50 hover:shadow-md">
          Load More
